...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--nyu_cat_file_name', type=str, default='dir_filenames/nyu_train_cat.npy')
        ...
        parser.add_argument('--kitti_online_cat_files', type=list, default=['kitti_residential_2.txt', 
                                                                              'kitti_city.txt',
                                                                              'kitti_campus.txt'])
        parser.add_argument('--kitti_cat_file_dir', type=str, default='dir_filenames/')
        ...
        parser.add_argument('--disp_model_path', type=str, default='trained_models/pretrained_models/kitti_nyu/Disp_019_05419.pth')
        parser.add_argument('--pose_model_path', type=str, default='trained_models/pretrained_models/kitti_nyu/Pose_019_05419.pth')
        ...
        # saving the model 
        parser.add_argument('--save_model_dir', type=str, default='trained_models/online_models_nyu_replay_reg_adapt/')
