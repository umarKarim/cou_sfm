...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--nyu_test_cat_file_name', type=str, default='dir_filenames/nyu_test_cat.npy')
        parser.add_argument('--kitti_eigen_test_split_file', type=str, default='dir_filenames/kitti_eigen_test_split.txt')
        parser.add_argument('--nyu_text_file_name', type=str, default='dir_filenames/nyu_text_file.txt')
